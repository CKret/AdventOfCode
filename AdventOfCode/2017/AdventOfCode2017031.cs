...
namespace AdventOfCode._2017
{
    ...
    /// </summary>
    [AdventOfCode(2017, 3, 1, "How many steps are required to carry the data from the square identified in your puzzle input all the way to the access port?", 326)]
