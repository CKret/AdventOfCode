...
namespace AdventOfCode._2017
{
    ...
    /// </summary>
    [AdventOfCode(2017, 21, "Fractal Art", 184, 2810258)]
    public class AdventOfCode201721 : AdventOfCodeBase
    {
        public AdventOfCode201721(string sessionCookie) : base(sessionCookie) { }
        ...
        protected override object SolvePart2()
        {
            ...
            foreach (var rule in Input)
            {
                ...
                rulesMap.TryAdd(from, to);
                rulesMap.TryAdd(AdventOfCode201721.FlipHorizontal(from), to);
                rulesMap.TryAdd(AdventOfCode201721.FlipVertical(from), to);

                for (var i = 0; i < 3; i++)
                {
                    var newFrom = AdventOfCode201721.Rotate(from);
                    rulesMap.TryAdd(newFrom, to);
                    rulesMap.TryAdd(AdventOfCode201721.FlipHorizontal(newFrom), to);
                    rulesMap.TryAdd(AdventOfCode201721.FlipVertical(newFrom), to);
            ...
            grid = AdventOfCode201721.CreateArt(18, grid, rulesMap);
