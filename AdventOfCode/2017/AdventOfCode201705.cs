...
namespace AdventOfCode._2017
{
    ...
    /// </summary>
    [AdventOfCode(2017, 5, "A Maze of Twisty Trampolines, All Alike", 375042, 28707598)]
    public class AdventOfCode201705 : AdventOfCodeBase
    {
        public AdventOfCode201705(string sessionCookie) : base(sessionCookie) { }

        protected override object SolvePart1()
        {
            var instr = Input.Select(int.Parse).ToList();
