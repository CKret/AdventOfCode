...
namespace AdventOfCode._2017
{
    ...
    /// cause a node to become infected? (Do not count nodes that begin infected.)
    /// </summary>
    [AdventOfCode(2017, 22, "Sporifica Virus", 5261, 2511927)]
    public class AdventOfCode201722 : AdventOfCodeBase
    {
        public AdventOfCode201722(string sessionCookie) : base(sessionCookie) { }
        ...
        protected override object SolvePart2()
        {
            ...
            for (var i = 0; i < 10000000; i++)
            {
                ...
                direction = Turn(nodes[(y, x)], direction);
                nodes[(y, x)] = ChangeState2(nodes[(y, x)]);
                if (nodes[(y, x)] == '#') count++;
                (x, y) = Move(x, y, direction);
            }
