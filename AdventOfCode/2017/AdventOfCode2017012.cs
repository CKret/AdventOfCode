...
namespace AdventOfCode._2017
{
    ...
    /// </summary>
    [AdventOfCode(2017, 1, 2, "Find the sum of all digits that match the digit halfway around in the list. The list is circular.", 1292)]
    public class AdventOfCode2017012 : AdventOfCodeBase
    {
        public override void Solve()
        {
            ...
            Result = captcha.Where((n, i) => n == captcha[(captcha.Length / 2 + i) % captcha.Length]).Sum();
        }
    }
}
