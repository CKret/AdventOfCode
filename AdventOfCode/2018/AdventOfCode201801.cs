...
namespace AdventOfCode._2018
{
    ...
    /// </summary>
    [AdventOfCode(2018, 1, "Chronal Calibration", 445, 219)]
    public class AdventOfCode201801 : AdventOfCodeBase
    {
        public AdventOfCode201801(string sessionCookie) : base(sessionCookie) { }

        protected override object SolvePart1()
        {
            return File.ReadAllLines("2018\\AdventOfCode201801.txt").Select(int.Parse).Sum();
        }
