...
namespace AdventOfCode._2018
{
	...
	/// But, I heard that a few days ago, they lost the prototype fabric, the
	...
	/// producing fgij.)
	/// </summary>
	[AdventOfCode(2018, 2, "Inventory Management System", 4940, "wrziyfdmlumeqvaatbiosngkc")]
	public class AdventOfCode201802 : AdventOfCodeBase
	{
		public AdventOfCode201802(string sessionCookie) : base(sessionCookie) { }
		...
		protected override object SolvePart1()
		{
			...
			{
				nBigrams += id.GroupBy(c => c).Any(g => g.Count() == 2) ? 1 : 0;
				nTrigrams += id.GroupBy(c => c).Any(g => g.Count() == 3) ? 1 : 0;
			}

			return nBigrams * nTrigrams;
		}
